...
exports.deactivate = exports.openImageInFile = exports.createCarbonImage = exports.activate = void 0;
...
function activate(context) {
    ...
    vscode.window.registerUriHandler({
        handleUri(uri) {
            if (uri.path === '/after-auth-2') {
                ...
                axios_1.default.get(tokenServerURL)
                    .then(response => {
    ...
    //showing bar 
    const linkedInPostSidebarProvider = new SidebarProvider_1.LinkedInPostSidebarProvider(context.extensionUri, context);
...
async function createCarbonImage(code) {
    ...
    for (let i = 0; i < apiAlternatives.length; i++) {
        try {
            const response = await axios_1.default.post(apiAlternatives[i], {
                code,
                theme: 'one-dark',
                exportSize: '2x',
...
async function openImageInFile(context, data) {
...
exports.openImageInFile = openImageInFile;
async function openImageInBrowser(url) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.LinkedInPostSidebarProvider = void 0;
const vscode = __webpack_require__(1);
const extension_1 = __webpack_require__(0);
const linkedInShare_1 = __webpack_require__(43);
const extension = __webpack_require__(0);
class LinkedInPostSidebarProvider {
    ...
    resolveWebviewView(webviewView) {
        ...
        webviewView.webview.onDidReceiveMessage(async (message) => {
            ...
            if (message.command == 'showError') {
                ...
                const imageData = await (0, extension_1.createCarbonImage)(code);
                if (imageData === null) {
                ...
                let imagePath = await (0, extension_1.openImageInFile)(this._context, imageData);
                ...
                const getAccessToken = async () => {
                    try {
                        ...
                        if (accessToken) {
                            ...
                            const result = await (0, linkedInShare_1.sharePostInLinkedIn)(sharePostData, accessToken);
                ...
                if (imagePath) {
                    const sharePostData = { description, imagePath };
                    try {
                        const result = await (0, linkedInShare_1.sharePostInLinkedIn)(sharePostData, ""); // changed the function to include the token 
                        // Handle the response from your server (e.g., show a success message, update the UI).
                    }
                    catch (error) {
                        // Handle the error case (e.g., show an error message).
...
exports.LinkedInPostSidebarProvider = LinkedInPostSidebarProvider;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.openLinkedInShare = exports.sharePostInLinkedIn = void 0;
const axios_1 = __webpack_require__(2);
const vscode = __webpack_require__(1);
async function sharePostInLinkedIn(sharePostData, accessToken) {
    try {
        const response = await axios_1.default.post('http://localhost:3000/share-post', sharePostData, {
...
exports.sharePostInLinkedIn = sharePostInLinkedIn;
function openLinkedInShare(description) {
    const url = `https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(description)}`;
    vscode.env.openExternal(vscode.Uri.parse(url));
}
exports.openLinkedInShare = openLinkedInShare;
